...
public class HeroClient {
    ...
    private static final String SERVER_IP = "172.25.144.1";
    ...
    private static void handleServerEvent(String serverJson) {
        ...
        JsonObject eventObject = gson.fromJson(serverJson, JsonObject.class);
        ...
        switch (eventType) {
            case "attackConfirmation":
                AttackConfirmationData confirmData = gson.fromJson(dataObject, AttackConfirmationData.class);
                System.out.println("Ответ сервера: " + confirmData.message + " | Здоровье злодея: " + confirmData.villainHp);
                break;

            case "villainAttack":
                VillainAttackData attackData = gson.fromJson(dataObject, VillainAttackData.class);
            ...
            case "gameOver":
                isGameOver = true;
                GameOverData gameOverData = gson.fromJson(dataObject, GameOverData.class);
                System.out.println("==========================================");
